...
public:
     ...
     */
    QPointF const& unitNormal() const
    {
        return m_unitNormal;
    }
private:
...
public:
    ...
    QSize const& spatialSize() const
    {
        return m_spatialSize;
    }

    QSize houghSize() const
    {
        return QSize(m_houghSpace.width(), m_houghSpace.height());
    }
    ...
    QLineF houghToSpatial(QPoint hough_pt) const
    {
        return houghToSpatial(hough_pt.x(), hough_pt.y());
    }

    QPointF const& spatialOrigin() const
    {
        return m_spatialOrigin;
    }

    Angle const& angleForRow(int row) const
    {
        return m_angles[row];
    }
     ...
     */
    int zeroDistanceCol() const
    {
        return m_zeroDistanceCol;
    }
    ...
    T houghValue(QPoint hough_pt) const
    {
        return houghValue(hough_pt.x(), hough_pt.y());
    }
private:
    /**
