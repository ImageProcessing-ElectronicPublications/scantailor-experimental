...
#include <memory>
#include "../Params.h"
#include "OrderByBWoriginProvider.h"

namespace output
{

OrderByBWoriginProvider::OrderByBWoriginProvider(IntrusivePtr<Settings> const& settings)
    :   m_ptrSettings(settings)
{
}

bool
OrderByBWoriginProvider::precedes(
    ...
    PageId const& rhs_page, bool const rhs_incomplete) const
{
    ...
    double lhs_bw = lhs_metrics.getMetricBWorigin();
    double rhs_bw = rhs_metrics.getMetricBWorigin();
