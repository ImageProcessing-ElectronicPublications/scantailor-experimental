...
#include <memory>
#include "../Params.h"
#include "OrderByMSEfiltersProvider.h"

namespace output
{

OrderByMSEfiltersProvider::OrderByMSEfiltersProvider(IntrusivePtr<Settings> const& settings)
    :   m_ptrSettings(settings)
{
}

bool
OrderByMSEfiltersProvider::precedes(
