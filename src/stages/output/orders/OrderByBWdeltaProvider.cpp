...
#include <memory>
#include "../Params.h"
#include "OrderByBWdeltaProvider.h"

namespace output
{

OrderByBWdeltaProvider::OrderByBWdeltaProvider(IntrusivePtr<Settings> const& settings)
    :   m_ptrSettings(settings)
{
}

bool
OrderByBWdeltaProvider::precedes(
    ...
    PageId const& rhs_page, bool const rhs_incomplete) const
{
    ...
    double lhs_bw = lhs_metrics.getMetricBWdestination() - lhs_metrics.getMetricBWorigin();
    double rhs_bw = rhs_metrics.getMetricBWdestination() - rhs_metrics.getMetricBWorigin();
