...
enum FilterColorAdditional { F_RIS, F_AUTOLEVEL, F_BALANCE, F_OVERBLUR, F_RETINEX, F_SUBTRACTBG, F_EQUALIZE, F_WIENER, F_KNND, F_EMD, F_DESPECKLE, F_SIGMA, F_BLUR, F_SCREEN, F_EDGEDIV, F_ROBUST, F_GRAIN, F_COMIX, F_ENGRAVING, F_DOTS8, F_UNPAPER };
