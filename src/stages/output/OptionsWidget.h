...
enum FilterColorAdditional { F_AUTOLEVEL, F_BALANCE, F_RETINEX, F_EQUALIZE, F_WIENER, F_KNND, F_DESPECKLE, F_SIGMA, F_BLUR, F_SCREEN, F_EDGEDIV, F_ROBUST, F_ENGRAVING, F_DOTS8, F_UNPAPER };
