...
enum ThresholdFilter { T_OTSU, T_MEANDELTA, T_DOTS8, T_BMTILED, T_NIBLACK, T_GATOS, T_SAUVOLA, T_WOLF, T_BRADLEY, T_GRAD, T_SINGH, T_WAN, T_EDGEPLUS, T_BLURDIV, T_EDGEDIV, T_EDGEADAPT, T_ROBUST, T_GRAIN, T_MSCALE, T_ENGRAVING };
